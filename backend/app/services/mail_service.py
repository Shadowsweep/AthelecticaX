...
async def _send_mail(recipient_email: str, subject: str, html_body: str):
    if IS_MAIL_ENABLED:
        try:
...
async def send_approval_email(recipient_email: str, name: str):
    ...
    <html>
        <body style="font-family: Arial, sans-serif; background-color: #0A0E17; color: #F1F5F9; padding: 20px;">
            <div style="border: 1px solid #1E293B; background-color: #111625; padding: 30px; border-top: 3px solid #00E5FF;">
                ...
                <br/>
                <a href="http://192.168.1.238:3000/login" style="display: inline-block; padding: 12px 24px; background-color: #00E5FF; color: #0A0E17; text-decoration: none; font-weight: bold; border-radius: 0px;">INITIATE DASHBOARD SESSION</a>
                <br/>
